...
(function(doc,win){
	function change(){
		doc.documentElement.style.fontSize=document.documentElement.clientWidth*12/320+'px';
	}
	change();
...
//	按键音乐
	var musicArr=['mp3/sgj_bt1.ogg','mp3/sgj_bt2.ogg','mp3/sgj_bt3.ogg','mp3/sgj_bt4.ogg','mp3/sgj_bt5.ogg','mp3/sgj_bt6.ogg','mp3/sgj_bt7.ogg','mp3/sgj_bt8.ogg'];
	music={
		start:'mp3/sgj_start.ogg',
		loop:'mp3/sgj_loop.ogg',
		end:'mp3/sgj_end.ogg',
		train:'mp3/sjg_xh.ogg'
	};
